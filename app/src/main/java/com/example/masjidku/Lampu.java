...
public class Lampu extends AppCompatActivity {
    ...
    private HelperAdapterLampu adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reff = FirebaseDatabase.getInstance().getReference("Listrik1");
...
//                    reff.child("tegangan").setValue("0 V");
        ...
        FirebaseRecyclerOptions option = new FirebaseRecyclerOptions.Builder<ListDataLampu>()
                .setQuery(query, ListDataLampu.class)
                .build();

        adapter = new HelperAdapterLampu(option);
